...
namespace RushHour.Utils
{
    public static class Log
    {
        ...
        const string Prefix = "PassengerCountFix: ";

        private static string logFilename = Path.Combine(Application.dataPath, "PassengerCountFix.log");
        ...
        private static void LogToFile(string log, LogLevel level)
        {
            ...
            try
            {
                ...
                {
                    w.WriteLine(DateTime.Now + " " + $"[{level.ToString()}] @ {sw.ElapsedTicks} {log}");
